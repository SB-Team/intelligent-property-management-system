...
public class ElecPayment {
	private int id;
	private double communityPayment; //社区分摊电费
	private double buildingPayment; //楼分摊电费
	private double floorPayment; //层分摊电费
	private ElecDegree roomElecDegree; //对应房间分摊电费表
	private double roomPayment; //社区分摊电费
	private int isPay; //是否付费，1代表已付费，0代表未付费
	private Room room; //对应所属房间
	private double total; //电费总价
	...
	public ElecPayment(int id, double communityPayment, double buildingPayment,
			double floorPayment, ElecDegree roomElecDegree, double roomPayment,
			int isPay, Room room, double total, String day) {
		super();
		this.id = id;
		this.communityPayment = communityPayment;
		this.buildingPayment = buildingPayment;
		this.floorPayment = floorPayment;
		this.roomElecDegree = roomElecDegree;
	...
	public ElecDegree getRoomElecDegree() {
		return roomElecDegree;
	}


	public void setRoomElecDegree(ElecDegree roomElecDegree) {
		this.roomElecDegree = roomElecDegree;
	}
