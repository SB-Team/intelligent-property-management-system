...
<div style="width: 360px;margin: 0 auto;">
	<ul>
		...
		<li>上次缴费日期：<s:property value="lastpaytime"/></li>
		<li>时长：<s:property value="day"/>天数</li>
...
<div style="width: 360px;margin: 0 auto;">
<s:form action="parking!getAllRentParkings.action" method="post">
<s:submit value="确定" />
</s:form>
</div> 
</div>
