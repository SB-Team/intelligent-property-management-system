		...
		<div class="home-page topbar">
					...
					<div class="navigation-menu pull-left">
						<ul class="nav global-action" id="global-actions">
							<li id="global-nav-home" class="home active new">
								<a class="owner-home-a js-tooltip-home" href="owner_index.jsp">
								<span class="icon icon-home">㍿</span>
								<span class="text">我的首页</span>
								</a>
							</li>
							<li id="global-nav-home" class="home new">
								<a class="owner-fee-a home-users-management js-tooltip-home" href="/">
								<span class="icon icon-home">㍿</span>
								<span class="text">费用管理</span>
								</a>
							</li>
							<li id="global-nav-profile" class="profile">
								<a class="owner-pp-a profile-a js-tooltip-profile" href="http://NeXT17.ME">
								<span class="icon icon-profile">♞</span>
								<span class="text">车位管理</span>
								</a>
							</li>
							<li id="global-nav-profile" class="profile">
								<a class="owner-he-a profile-a js-tooltip-profile" href="http://NeXT17.ME">
								<span class="icon icon-profile">☁</span>
								<span class="text">社区服务</span>
								</a>
							</li>
							<li id="global-nav-profile" class="profile">
								<a class="owner-profile-a profile-a js-tooltip-profile" href="http://NeXT17.ME">
								<span class="icon icon-profile">☁</span>
			...
			<div class="sub-menus-pool" >
				<div id="sub-menu-1" class="sub-menu" style="left: 277px; width: 170px; background: #000; background: rgba(0, 0, 0, 0.53);">
					<div class="submenu-title">
               		...
               		<dl class="first" style="width: 160px; height: 165px;">
                                ...
                                <dd>
                                    <a href="water!ownerViewWaterBill.action">水费管理</a>
                                </dd>
                            	<dd>
                                    <a href="elec!ownerViewElecBill.action">电费管理</a>
                                </dd>
                                <dd>
                                    <a href="scanAll!getUsers.action">停车费管理</a>
                                </dd>
				...
				<div id="sub-menu-2" class="sub-menu" style="left: 393px; width: 240px;background: rgba(0, 0, 0, 0.529412);">
					<div class="submenu-title">
	                    <h3>
	                        <a href="http://next17.me" target="_blank" >车位管理</a>
	                    </h3>
                	...
                	<dl class="first" style="width: 160px; height: 165px;">
                                ...
                                <dd>
                                    <a href="parking">我的车位信息</a>
                                </dd>
                            	<dd>
                                    <a href="usermodify.jsp">临时车位信息</a>
                                </dd>
                                <dd>
                                    <a href="scanAll!getUsers.action">停车费管理</a>
                                </dd>
