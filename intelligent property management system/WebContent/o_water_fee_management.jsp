...
<table class="all-users">
	...
	<tr>
		<td>房间水费</td>
		<td><s:property value="ownerViewThisWaterBill.roomDegree.lastEnteringTime"/>~<s:property value="ownerViewThisWaterBill.roomDegree.thisEnteringTime"/></td>
		<td><s:property value="ownerViewThisWaterBill.roomDegree.lastEnteringDegree"/></td>
		<td><s:property value="ownerViewThisWaterBill.roomDegree.thisEnteringDegree"/></td>
		<td><s:property value="ownerViewThisWaterBill.roomDegree.degree"/></td>
		<td><s:property value="ownerViewThisWaterBill.roomPayment"/>元</td>
	</tr>
	<tr class="first-row" align="center"  height="22">
		<td width="10%">项目名称</td>
		<td width="10%">时间周期</td>
	...
	<tr>
		<td>公摊小区水费</td>
		<td><s:property value="ownerCommunityWaterDegree.lastEnteringTime"/>~<s:property value="ownerCommunityWaterDegree.thisEnteringTime"/></td>
		<td><s:property value="ownerViewThisWaterBill.communityPayment"/>元</td>
	</tr>
	<tr>
		<td>公摊楼水费</td>
		<td><s:property value="ownerBuildingWaterDegree.lastEnteringTime"/>~<s:property value="ownerBuildingWaterDegree.thisEnteringTime"/></td>
		<td><s:property value="ownerViewThisWaterBill.buildingPayment"/>元</td>
	</tr>
	<tr>
		<td>公摊层水费</td>
		<td><s:property value="ownerFloorWaterDegree.lastEnteringTime"/>~<s:property value="ownerFloorWaterDegree.thisEnteringTime"/></td>
		<td><s:property value="ownerViewThisWaterBill.floorPayment"/>元</td>
	</tr>
	<tr class="first-row" align="center"  height="22">
	...
	<tr>
		<td><s:property value="ownerViewThisWaterBill.total"/>元</td>
		<td><s:property value="ownerDebt.waterDebt"/>元</td>
		<td><s:property value="waterTotalWithDebt"/>元</td>
		<td><s:if  test='%{ownerViewThisWaterBill.isPay!=0}'>已付费</s:if>
			<s:else>未付费</s:else>
		</td>
	...
	<s:if test='%{ownerViewThisWaterBill.isPay==0}'>
	<s:form action="o_water_makepayment.jsp" method="post">
		<s:submit value="支付" />
	</s:form>
	</s:if>
	</div>
